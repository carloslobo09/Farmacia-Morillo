...
<body>
    ...
    if (
        ...
        $objeto->conectar();
        $objeto->creartb();
        echo $objeto->restar($id_ins, $cls, $na,$otr);
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <form name="tuformulario" method="post" action="restar.php" align="center">
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" required name="cls" class="form-control" placeholder="Unidades Salientes por Clearing" value="<?PHP echo $cls ?>">
                        <br>
                        <input type="number" required name="na" class="form-control" placeholder="Unidades Salientes por No Aptos" value="<?PHP echo $na ?>">
                        <br>
                        <input type="number" required name="otr" class="form-control" placeholder="Unidades Salientes por Otros" value="<?PHP echo $otr ?>">
                        ...
                        <input type="hidden" name="consumom" class="form-control" placeholder="Consumo Promedio Mensual(Solo números)" value="<?PHP echo $consumom ?>">
                        <br>
