...
<body>
    ...
    if (
        ...
        $objeto->creartb();
        if ($unide != 0) {
            echo $objeto->unidadesentregadas($id_ins, $unide);
            echo $objeto->ue($id_ins,$unide);
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <form name="tuformulario" method="post" action="ue.php" align="center">
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" required name="unide" class="form-control" placeholder="Unidades Entregadas" value="<?PHP echo $unide ?>">
